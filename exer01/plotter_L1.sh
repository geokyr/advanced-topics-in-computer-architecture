...
for bench in "${BenchArray[@]}"; do
    python3 graph_L1.py "false" "${bench}" ${OUT_PATH}/${bench}*
    mv L1.png ./graphs/L1/L1_${bench}.png
done

# Create the graphs for the second question
for bench in "${BenchArray[@]}"; do
    python3 graph_L1.py "true" "${bench}, IPC Reduction" ${OUT_PATH}/${bench}*
    mv L1.png ./graphs/L1/L1_${bench}_Red.png
done
