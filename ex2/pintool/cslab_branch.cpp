...
VOID InitPredictors()
{
    ...
    // int bht_entries = 4*KILO; // 2048 entries
    // int bht_bits = 4; 
    // int pht_index = 9; //index bits
    ...
    // BranchPredictor *p1 = new NbitPredictor(11, 8); // 16K Overhead
    // bp = new TournamentPredictor(1024, p0, p1);
    // branch_predictors.push_back(bp);

    // p0 = new GlobalHistoryPredictor(2,11,2);
    // p1 = new NbitPredictor(14, 1);
    // bp = new TournamentPredictor(2048, p0, p1);
    // branch_predictors.push_back(bp);

    // p0 = new GlobalHistoryPredictor(5, 8, 2); // 4* 4K = 16K Overhead
    // p1 = new LocalHistoryPredictor(4*KILO, 2, 9, 4); // 8K BHT, 4*2K=8K PHT
    // bp = new TournamentPredictor(1024, p0, p1);
    // branch_predictors.push_back(bp);

    // p0 = new NbitPredictor(11, 8); // 16K Overhead
    // p1 = new GlobalHistoryPredictor(2, 11, 2); // 8K BHT, 4*2K=8K PHT
    // bp = new TournamentPredictor(1024, p0, p1);
    // branch_predictors.push_back(bp);
