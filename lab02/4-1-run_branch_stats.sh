...
PIN_TOOL=/home/george/adv-ca/advcomparch-22-ex2-helpcode/pintool/obj-intel64/cslab_branch_stats.so
outDir="/home/george/adv-ca/parsec-3.0/parsec_workspace/outputs/4-1"
...
for BENCH in $BENCHMARKS; do
	...
	pinOutFile="$outDir/${BENCH}.cslab_branch_stats.out"
